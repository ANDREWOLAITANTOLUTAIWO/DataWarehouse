...
Create Table Structures in 'silver' layer with DDL
...
if object_id('silver.erp_cust_azi2', 'u') is not null
	drop table silver.erp_cust_azi2
create table silver.erp_cust_azi2(
CID nvarchar(50),
BDATE date,
GEN nvarchar(50),
dwh_create_date datetime2 default getdate()
